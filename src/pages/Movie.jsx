...
const Movie = () => {
  ...
  const getMovie = async (url) => { // arrow function que busca os filmes com melhor notas da API que recebe a url da própria API
    ...
    setMovie(data) // não precisa do .results porque só vem um dado
